...
REM
REM Generated by Vivado on Wed Dec 31 09:51:07 +0200 2025
...
echo "xvlog --incr --relax -prj Adder_logic_circuit_tb_vlog.prj"
call xvlog  --incr --relax -prj Adder_logic_circuit_tb_vlog.prj -log xvlog.log
