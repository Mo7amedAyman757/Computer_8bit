...
REM
REM Generated by Vivado on Sun Dec 28 23:15:20 +0200 2025
...
echo "xvlog --incr --relax -prj interrupt_tb_vlog.prj"
call xvlog  --incr --relax -prj interrupt_tb_vlog.prj -log xvlog.log
