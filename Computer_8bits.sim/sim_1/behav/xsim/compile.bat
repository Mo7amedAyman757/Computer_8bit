...
REM
REM Generated by Vivado on Tue Feb 03 02:19:59 +0200 2026
...
echo "xvlog --incr --relax -prj mano8bit_tb_vlog.prj"
call xvlog  --incr --relax -prj mano8bit_tb_vlog.prj -log xvlog.log
