...
HD_PWD='D:/Career tracks/Digial_IC/07-IcDesign_Projects/08-Mano_Design/Computer_8bits/Computer_8bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mano_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mano_8bit.tcl -notrace
