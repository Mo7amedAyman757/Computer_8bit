...
HD_PWD='D:/Career tracks/Digial_IC/07-IcDesign_Projects/08-Mano_Design/Computer_8bits/Computer_8bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mano_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mano_8bit.tcl
